...
<head>
    ...
    <!-- VENDOR CSS -->
    <link rel="stylesheet" href="{{ asset('public/assets-app/new/vendor/bootstrap/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('public/assets-app/new/vendor/font-awesome/css/font-awesome.min.css') }}">
    <link rel="stylesheet" href="{{ asset('public/assets-app/new/vendor/linearicons/style.css') }}">
    <!-- MAIN CSS -->
    <link rel="stylesheet" href="{{ asset('public/assets-app/new/css/main.css') }}">
    <!-- FOR DEMO PURPOSES ONLY. You should remove this in your project -->
    <link rel="stylesheet" href="{{ asset('public/assets-app/new/css/demo.css') }}">
    <!-- GOOGLE FONTS -->
