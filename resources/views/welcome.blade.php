...
<head>
    ...
    <!-- VENDOR CSS -->
    <link rel="stylesheet" href="{{ asset('asset/new/vendor/bootstrap/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('asset/new/vendor/font-awesome/css/font-awesome.min.css') }}">
    <link rel="stylesheet" href="{{ asset('asset/new/vendor/linearicons/style.css') }}">
    <!-- MAIN CSS -->
    <link rel="stylesheet" href="{{ asset('asset/new/css/main.css') }}">
    <!-- FOR DEMO PURPOSES ONLY. You should remove this in your project -->
    <link rel="stylesheet" href="{{ asset('asset/new/css/demo.css') }}">
    <!-- GOOGLE FONTS -->
...
<script src="{{ asset('asset/new/vendor/jquery/jquery.min.js') }}"></script>
<script src="{{ asset('asset/new/vendor/bootstrap/js/bootstrap.min.js') }}"></script>
<script src="{{ asset('asset/new/vendor/bootstrap/js/bootstrap.min.js') }}"></script>
<script src="{{ asset('asset/new/vendor/jquery-slimscroll/jquery.slimscroll.min.js') }}"></script>
<script src="{{ asset('asset/new/scripts/klorofil-common.js') }}"></script>
